...
app.get("/registrarse",(req,res) => res.sendFile(path.join(views,"registro.html")))
app.get("/registroexitoso",(req,res) => res.sendFile(path.join(views,"hola.html")))
app.get("/logeoexitoso",(req,res) => res.sendFile(path.join(views,"hola2.html")))
